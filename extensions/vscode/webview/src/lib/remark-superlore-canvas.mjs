 ...
 *
 * COPIED verbatim from apps/docs/lib/remark-superlore-canvas.mjs so the extension is self-contained.
 * Could later be centralized into the `superlore` package and imported from there.
 */
